    ...
    <div className="min-h-screen bg-[#08080c] text-white">
      ...
      <main className="mx-auto max-w-2xl px-8 pt-40 pb-28 text-center">
        ...
        <p className="mt-4 text-white/60">
          Refer agency owners to Nova and earn recurring commission on every plan they keep. The program isn't live
          yet — sign up for an account and we'll let you know the moment it launches.
        </p>
        <Link
          to="/signup"
